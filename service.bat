...
set "GITHUB_VERSION_URL=https://raw.githubusercontent.com/orderdyerknot/obHODTelegRAM/main/.service/version.txt"
set "GITHUB_RELEASE_URL=https://github.com/orderdyerknot/obHODTelegRAM/releases/tag/"
set "GITHUB_DOWNLOAD_URL=https://github.com/orderdyerknot/obHODTelegRAM/releases/latest"
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/orderdyerknot/obHODTelegRAM/issues/417"
) else (
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/orderdyerknot/obHODTelegRAM/issues/2512#issuecomment-2821119513"
) else (
...
set "listFile=%~dp0lists\ipset-all.txt"
set "url=https://raw.githubusercontent.com/orderdyerknot/obHODTelegRAM/refs/heads/main/.service/ipset-service.txt"
...
set "hostsFile=%SystemRoot%\System32\drivers\etc\hosts"
set "hostsUrl=https://raw.githubusercontent.com/orderdyerknot/obHODTelegRAM/refs/heads/main/.service/hosts"
...
if %errorLevel% neq 0 (
    ...
    echo Fix your PATH variable with instructions here https://github.com/orderdyerknot/obHODTelegRAM/issues/7490
    pause
    exit /b 1
)
exit /b 0
...
exit /b 0
rem id orderdyerknot/obHODTelegRAM a4fbcc9b
